...
```
git clone https://github.com/Sushobhan03/Foundry-fund-me
cd Foundry-fund-me
make
```
...
- `SEPOLIA_RPC_URL`: This is url of the sepolia testnet node you're working with. You can get set up with one for free from [Alchemy](https://alchemy.com/?a=673c802981)
